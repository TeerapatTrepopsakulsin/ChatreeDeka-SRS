...
% TCCC & Thai Civil and Commercial Code; the primary set of laws used in this simulation. \\
% Matra (Section) & The specific numbered legal rules within the Thai code (e.g., Section 420 for Tort). \\
...
% Deka (Dika) & A final ruling by the Supreme Court of Thailand, used in this project as the ``Ground Truth'' for accuracy. \\
